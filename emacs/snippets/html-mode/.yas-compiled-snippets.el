...
(yas-define-snippets 'html-mode
                     '(("b" "<b>$0</b>" "<b>...</b>" nil nil nil nil nil nil)
                       ...
                       ("btn" "<button type=\"$1\"${2: id=\"${3:some_id}\"}${4: class=\"${5:some_class}\"}>$0</button>" "<button... ></button>" nil nil nil nil nil nil)
                       ...
                       ("input" "<input type=\"$1\" name=\"$2\" value=\"$3\" placeholder=\"$4\"/>" "<input ... />" nil nil nil nil nil nil)
...
;;;
(yas-define-snippets 'html-mode
                     '(("table" "<table${1: width=\"$2\" cellspacing=\"$3\" cellpadding=\"$4\" border=\"$5\"} ${6: class=\"${7:some_class}\"}>\n  $0\n</table>" "<table ...>...</table>" nil
                        ("table")
                        nil nil nil nil)
